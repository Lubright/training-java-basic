...
public class ex6_JList2 extends JFrame implements ListSelectionListener, ActionListener{
	...
	private static enum ex6_JList2_Color{
		red, blue, green;
		
		// self defined int to ex6_JList1_Color
		public static ex6_JList2_Color toEx6_JList1_Color(int v) {
			switch(v) {
			case 0:
				return red;
			case 1:
	...
	public ex6_JList2() throws ImageReadException, IOException {
		// frame setting
		...
		this.setIconImage(imgIcon); // set icon
...
//		jList.addListSelectionListener(this);
		jList.addMouseListener(new MouseAdapter() {
			private ex6_JList2 that;
			@Override
			public void mouseClicked(MouseEvent e) {
				if(e.getSource() == jList) {
					if(e.getClickCount()==2) { // 連點兩下
						that.valueChanged(jList);
					}
				}
			}
			
			// catch var from outside
			public MouseAdapter init(ex6_JList2 that) {
				this.that = that; // like js
				return this;
			}
			
		}.init(this)); // 傳入 this object
		
		// add scrollPane and put jList to it
	...
	public static void main(String[] args) throws ImageReadException, IOException {
		new ex6_JList2().setVisible(true);
	...
	public void valueChanged(ListSelectionEvent e) {
		...
		ex6_JList2_Color selectColor = ex6_JList2_Color.toEx6_JList1_Color(jList.getSelectedIndex());
		switch(selectColor) {
		case red:
	...
	public void valueChanged(JList<String> jList) {
		label.setForeground(Color.black);
